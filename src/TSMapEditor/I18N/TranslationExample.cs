...
{
    /// <summary>
    /// Example class demonstrating how to use the L10N translation system.
    /// This class will be scanned by the TranslationNotifierGenerator to extract translation strings.
    /// </summary>
    public static class TranslationExample
    {
        /// <summary>
        /// Example method showing different ways to use L10N.
        /// </summary>
        public static void ExampleUsage()
        {
            // Basic usage - default value is used as key
            ...
            // Usage with INI-style keys (for UI controls)
